Shader "Unreal/MI_Wall_Decal"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Wall_Decal_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Wall_Decal", 2D ) = "white" {}
		Material_Texture2D_2( "T_Wall_Decal_R", 2D ) = "white" {}
