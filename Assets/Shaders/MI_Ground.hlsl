...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.250000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,1.500000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local12 = (Local10.g * Material.PreshaderBuffer[2].w);
