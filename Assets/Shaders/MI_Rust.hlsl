...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 1);
	MaterialFloat4 Local10 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local11 = MaterialStoreTexSample(Parameters, Local10, 1);
	MaterialFloat3 Local12 = PositiveClampedPow(Local10.rgb,((MaterialFloat3)2.00000000));
	MaterialFloat3 Local13 = (((MaterialFloat3)1.00000000) - Local12);
	MaterialFloat Local14 = (Local10.g * Material.PreshaderBuffer[2].w);
	MaterialFloat3 Local15 = (Local13 + ((MaterialFloat3)Local14));
	MaterialFloat Local16 = lerp(1.00000000,Local10.r,Material.PreshaderBuffer[3].x);
