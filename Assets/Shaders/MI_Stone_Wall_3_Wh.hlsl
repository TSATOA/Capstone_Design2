...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.569841,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(0.000000,0.000000,0.000000,5.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = LWCToFloat(DERIV_BASE_VALUE(Local10));
	MaterialFloat3 Local12 = LWCMultiplyVector(DERIV_BASE_VALUE(Local11), GetPrimitiveData(Parameters).WorldToLocal);
	MaterialFloat3 Local13 = CustomExpression0(Parameters);
	MaterialFloat3 Local14 = CustomExpression1(Parameters);
	MaterialFloat3 Local15 = (Local13 - Local14);
	MaterialFloat3 Local16 = (DERIV_BASE_VALUE(Local12) / Local15);
	MaterialFloat3 Local17 = (Local16 * ((MaterialFloat3)Material.PreshaderBuffer[4].w));
	MaterialFloat Local18 = saturate(Local17.b);
	MaterialFloat3 Local19 = lerp(Local9,Local7.rgb,Local18);
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local21 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 0);
	MaterialFloat Local23 = (Local21.g * Material.PreshaderBuffer[5].x);
